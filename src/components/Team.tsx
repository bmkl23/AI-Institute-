...
export function Team() {
  return (
    <section id="team" className="border-b border-white/[0.06] bg-slate-950 py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        >
          ...
          <h2 className="mt-2 text-3xl font-bold text-white md:text-4xl">Mentors who ship, teach, and iterate</h2>
          <p className="mt-4 text-slate-400">
            A hybrid faculty of research leads, staff engineers, and product strategists—aligned on practical craft.
          </p>
        </motion.div>
